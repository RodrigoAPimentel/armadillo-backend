...
import { TradeStrategiesService } from './tradeStrategies.service';
import { JWTAuthGuard } from '../auth/jwt/jwt-auth.guard';
import Logger from 'src/logger/Logger';

@UseGuards(JWTAuthGuard)
@Controller('tradeStrategies')
export class TradeStrategiesController {
  constructor(
    private readonly service: TradeStrategiesService,
    private logger: Logger,
  ) {}

  @Post()
  async create(@Body() entity: ITradeStrategies) {
  ...
  @Put(':id')
  async update(@Param('id') id: string, @Body() entity: ITradeStrategies) {
